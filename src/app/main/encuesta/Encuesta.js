	...
	return (
		<FusePageCarded
						...
						<div className="flex flex-col items-start max-w-full">
							<FuseAnimate animation="transition.slideRightIn" delay={300}>
								...
								>
									...
									<span className="mx-4">Tablero de Control</span>
								</Typography>
							</FuseAnimate>
						</div>
					</div>
			...
			contentToolbar={
				...
				>
					<Tab className="h-64 normal-case" label="Habitos Saludables" />
					<Tab className="h-64 normal-case" label="Cuidado Personal" />
					<Tab className="h-64 normal-case" label="Bienestar Saludable" />
					<Tab className="h-64 normal-case" label="Mis cuidados medicos" />
				</Tabs>
			}
			content={
				form && (
