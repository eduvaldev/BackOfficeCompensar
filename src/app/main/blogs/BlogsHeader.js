...
import { openNewBlogDialog, setSearchText, setSelectedStatus } from '../../store/app/blogsSlice';
						...
						<div className="lg:flex-row lg:space-y-0 flex flex-col justify-between w-full h-full space-y-10">
							...
							<div className="flex h-full">
								<Button
									...
									startIcon={<FiPlus />}
									variant="contained"
									onClick={() => dispatch(openNewBlogDialog())}
								>
									<span className="sm:flex hidden">Agregar Blog</span>
